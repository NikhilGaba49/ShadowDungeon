...
Defined as a separate class, upon discussion with Stefan since there will likely
 be a need to be adjusted in Project 2 - unsure at this stage.  */
public class Enemy extends StationaryObject {

    // initialise the enemy with the correct file
    public Enemy(Point coordinates) {
        super(coordinates, "res/key_bullet_kin.png");
    }
}